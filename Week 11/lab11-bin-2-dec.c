...
int main(int argc, char *argv[]) {
    int length = argc - 1;
    Node *head = NULL;
    // Corrected calloc to allocate memory for int instead of int*
    ...
    // Code to free the linked list should be added here
...
Node *new_node() {
    // Corrected calloc to allocate memory for Node instead of Node*
