...
Date: 2/11/2023
Description: Program gets shopping list with items; item, amount, price, promotion.
Checks if item is on sale or not. Displays item, amount, price, and if there is a promotion
*/
